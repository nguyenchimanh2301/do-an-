    ...
    class FormSV
    {
        ...
        public void hien()
        {
            ...
            foreach(var p in list )
            {
                ...
                gd.pain(Convert.ToString(p.Sdt1), 79, j);
                j++;
            }
        ...
        public void timsv()
        {
            ...
            if (i < list.Count)
            {
                SV sv = new SV(list[i]);
                Console.WriteLine("\n\n");
                Console.WriteLine("THÔNG TIN HÓA SINH VIÊN  MUỐN TÌM");
                gd.pain("MÃ PHÒNG", 14, 13);Console.SetCursorPosition(28, 13); Console.WriteLine(list[i].Maph);
                gd.pain(" MÃ SV", 14, 15); Console.SetCursorPosition(28, 15); Console.WriteLine(list[i].Masv);
                gd.pain("HỌ TÊN", 14, 17); Console.SetCursorPosition(28, 17); Console.WriteLine(list[i].Tensv);
                gd.pain("GIỚI TÍNH", 14, 19); Console.SetCursorPosition(28, 19); Console.WriteLine(list[i].Gioitinh);
                gd.pain("ĐỊA CHỈ", 14, 21); Console.SetCursorPosition(28, 21); Console.WriteLine(list[i].Diachi);
                gd.pain("TÊN LỚP", 14, 23); Console.SetCursorPosition(28, 23); Console.WriteLine(list[i].Tenlop);
                gd.pain("SỐ ĐT", 14, 25); Console.SetCursorPosition(28, 25); Console.WriteLine(list[i].Sdt1);
            }
            else
            {
                Console.WriteLine("không tồn tại mã sinh viên");
